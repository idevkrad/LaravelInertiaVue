            ...
            <b-container>
                ...
                <b-col lg="12">
                    ...
                    <div>
                        ...
                        <img class="rounded-circle avatar-md" src="/images/wmsu.png" alt="" height="20" />
                        </router-link>
                    </div>
                ...
                <b-col md="8" lg="6" xl="5">
                    ...
                    <b-card-body class="p-4">
                        ...
                        <h5 class="text-primary">MyWMSU Portal</h5>
                        <p class="text-muted mt-n1">Sign in to continue to Wmsu Portal.</p>
                        </div>
                        <div class="p-2 mt-4">
